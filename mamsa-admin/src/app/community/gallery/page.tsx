...
export const revalidate = 300; // Increase to 5 minutes - gallery doesn't change frequently

export default async function GalleryPage() {
  // Limit to 100 images per page - add pagination later if needed
  const { data: images, error } = await fetchPublishedGallery(100);

          ...
          <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                {showProfile && (
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-100 z-[60] overflow-hidden">
                    {/* Header */}
                    ...
                    <div className="border-t border-gray-100 px-4 py-2">
                      <button
                        ...
                        className="flex items-center w-full px-2 py-2.5 text-sm text-red-600 hover:bg-red-50 hover:text-red-700 transition-colors duration-150 rounded-lg"
                      >
